...
==============================================
/*
更新时间: 2020-12-16 23:00
Github Actions使用方法见[@lxk0301](https://raw.githubusercontent.com/lxk0301/scripts/master/githubAction.md) 使用方法大同小异

请自行抓包，阅读文章和看视频，倒计时转一圈显示青豆到账即可，多看几篇文章和视频，获得更多包数据，抓包地址为"https://app.kxp.com/video/v1/video/complete"，在Github Actions中的Secrets新建name为'RONGHUA_VIDEO'的一个值，拷贝抓包的请求体到下面Value的文本框中，添加的请求体不用太多，目前测试3000金币左右，脚本不包含任何推送通知
